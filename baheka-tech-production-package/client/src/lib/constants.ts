...
export const SERVICES = [
  {
    ...
    description: "Custom software solutions built with modern technologies and best practices for scalability and performance.",
    icon: "Code",
    features: [
...
export const BLOG_POSTS = [
  {
    ...
    excerpt: "Explore the emerging trends shaping the financial technology landscape and how they'll impact businesses.",
...
export const CAREER_POSITIONS = [
  ...
  },
  {
    ...
    type: "Full-time",
    description: "Lead our cybersecurity initiatives and help protect our clients' critical infrastructure.",
    requirements: [
  ...
  },
  {
    ...
    location: "San Francisco, CA / Remote",
    type: "Full-time",
    description: "Create intuitive and beautiful user experiences for our diverse range of technology products.",
    requirements: [
    ...
    benefits: [
      "Competitive salary and equity",
      "Comprehensive health insurance",
      "Design tools and equipment allowance",
